...
// AMLIndicator 
export type AMLIndicator = boolean;
...
export type ExternalUnableToApplyIncorrectData1Code = string;

// ExternalUnableToApplyMissingData1Code 
export type ExternalUnableToApplyMissingData1Code = string;
...
export class IncorrectData1Choice {
	Cd: string;
	Prtry: string;
}
...
// MissingData1Choice 
export class MissingData1Choice {
	Cd: string;
	Prtry: string;
}

// MissingOrIncorrectData1 
export class MissingOrIncorrectData1 {
	AMLReq: boolean;
	MssngInf: Array<UnableToApplyMissing2>;
	IncrrctInf: Array<UnableToApplyIncorrect2>;
}
...
export class UnableToApplyIncorrect2 {
	Tp: IncorrectData1Choice;
	AddtlIncrrctInf: string;
}

// UnableToApplyJustification4Choice 
export class UnableToApplyJustification4Choice {
	AnyInf: boolean;
	MssngOrIncrrctInf: MissingOrIncorrectData1;
	PssblDplctInstr: boolean;
}

// UnableToApplyMissing2 
export class UnableToApplyMissing2 {
	Tp: MissingData1Choice;
	AddtlMssngInf: string;
}

// UnableToApplyV09 
export class UnableToApplyV09 {
