...
export class CreditTransferTransaction44 {
...
export class FinancialInstitutionCreditTransferV09 {
	GrpHdr: GroupHeader93;
	CdtTrfTxInf: Array<CreditTransferTransaction44>;
	SplmtryData: Array<SupplementaryData1>;
}
...
export class RemittanceInformation2 {
	Ustrd: string;
}
