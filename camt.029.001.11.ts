...
export enum CancellationIndividualStatus1Code {
	RJCR = 'RJCR',
	ACCR = 'ACCR',
	PDCR = 'PDCR',
}
...
export class CancellationStatusReason3Choice {
	Cd: string;
	Prtry: string;
}

// CancellationStatusReason4 
export class CancellationStatusReason4 {
...
// ChargeType3Choice 
export class ChargeType3Choice {
	Cd: string;
	Prtry: GenericIdentification3;
}

// Charges6 
export class Charges6 {
	TtlChrgsAndTaxAmt: ActiveOrHistoricCurrencyAndAmount;
	Rcrd: Array<ChargesRecord3>;
}

// Charges9 
export class Charges9 {
...
export class CompensationReason1Choice {
	Cd: string;
	Prtry: string;
}
...
export class CorrectiveGroupInformation1 {
	MsgId: string;
	MsgNmId: string;
	CreDtTm: string;
}
...
export class CorrectiveInterbankTransaction3 {
...
export class CorrectivePaymentInitiation5 {
	GrpHdr: CorrectiveGroupInformation1;
	PmtInfId: string;
	InstrId: string;
	EndToEndId: string;
...
export class CorrectiveTransaction5Choice {
...
export type ExternalClaimNonReceiptRejection1Code = string;
...
export type ExternalInvestigationExecutionConfirmation1Code = string;
...
export type ExternalPaymentCancellationRejection1Code = string;

// ExternalPaymentCompensationReason1Code 
export type ExternalPaymentCompensationReason1Code = string;

// ExternalPaymentModificationRejection1Code 
export type ExternalPaymentModificationRejection1Code = string;
...
export enum GroupCancellationStatus1Code {
	PACR = 'PACR',
	RJCR = 'RJCR',
	ACCR = 'ACCR',
	PDCR = 'PDCR',
...
export class InvestigationStatus5Choice {
	Conf: string;
	RjctdMod: Array<ModificationStatusReason1Choice>;
	DplctOf: Case5;
	AssgnmtCxlConf: boolean;
}
...
export class ModificationStatusReason1Choice {
	Cd: string;
	Prtry: string;
}

// ModificationStatusReason2 
export class ModificationStatusReason2 {
	Orgtr: PartyIdentification135;
...
export class NumberOfCancellationsPerStatus1 {
	DtldNbOfTxs: string;
	DtldSts: string;
	DtldCtrlSum: number;
}
...
export class NumberOfTransactionsPerStatus1 {
	DtldNbOfTxs: string;
	DtldSts: string;
	DtldCtrlSum: number;
}
...
export class OriginalGroupHeader14 {
	OrgnlGrpCxlId: string;
	RslvdCase: Case5;
	OrgnlMsgId: string;
	OrgnlMsgNmId: string;
	OrgnlCreDtTm: string;
	...
	OrgnlCtrlSum: number;
	GrpCxlSts: string;
	CxlStsRsnInf: Array<CancellationStatusReason4>;
	NbOfTxsPerCxlSts: Array<NumberOfTransactionsPerStatus1>;
}
...
export class OriginalPaymentInstruction43 {
	OrgnlPmtInfCxlId: string;
	RslvdCase: Case5;
	...
	PmtInfCxlSts: string;
	CxlStsRsnInf: Array<CancellationStatusReason4>;
	NbOfTxsPerCxlSts: Array<NumberOfCancellationsPerStatus1>;
	TxInfAndSts: Array<PaymentTransaction139>;
}
...
export class PaymentTransaction132 {
	ModStsId: string;
	RslvdCase: Case5;
	OrgnlGrpInf: OriginalGroupInformation29;
	OrgnlPmtInfId: string;
	...
	OrgnlUETR: string;
	ModStsRsnInf: Array<ModificationStatusReason2>;
...
export class PaymentTransaction138 {
	CxlStsId: string;
	RslvdCase: Case5;
	OrgnlGrpInf: OriginalGroupInformation29;
	OrgnlInstrId: string;
...
export class PaymentTransaction139 {
	CxlStsId: string;
	RslvdCase: Case5;
	OrgnlInstrId: string;
	OrgnlEndToEndId: string;
...
export class ResolutionData3 {
	...
	Chrgs: Array<Charges9>;
}

// ResolutionOfInvestigationV11 
export class ResolutionOfInvestigationV11 {
	Assgnmt: CaseAssignment5;
	RslvdCase: Case5;
	Sts: InvestigationStatus5Choice;
	CxlDtls: Array<UnderlyingTransaction29>;
...
export class StatementResolutionEntry4 {
	OrgnlGrpInf: OriginalGroupInformation29;
	OrgnlStmtId: string;
	UETR: string;
	AcctSvcrRef: string;
	CrrctdAmt: ActiveOrHistoricCurrencyAndAmount;
	Chrgs: Array<Charges6>;
	Purp: Purpose2Choice;
}
...
export enum TransactionIndividualStatus1Code {
	ACTC = 'ACTC',
	RJCT = 'RJCT',
	PDNG = 'PDNG',
	ACCP = 'ACCP',
...
export class UnderlyingTransaction29 {
	OrgnlGrpInfAndSts: OriginalGroupHeader14;
	OrgnlPmtInfAndSts: Array<OriginalPaymentInstruction43>;
	TxInfAndSts: Array<PaymentTransaction138>;
}
