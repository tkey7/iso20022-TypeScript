...
export type ExternalPaymentGroupStatus1Code = string;

// ExternalPaymentTransactionStatus1Code 
export type ExternalPaymentTransactionStatus1Code = string;
...
export type ExternalStatusReason1Code = string;

// ExternalTaxAmountType1Code 
export type ExternalTaxAmountType1Code = string;

// FIToFIPaymentStatusReportV11 
export class FIToFIPaymentStatusReportV11 {
	GrpHdr: GroupHeader91;
	OrgnlGrpInfAndSts: Array<OriginalGroupHeader17>;
	TxInfAndSts: Array<PaymentTransaction123>;
...
export class NumberOfTransactionsPerStatus5 {
	DtldNbOfTxs: string;
	DtldSts: string;
	DtldCtrlSum: number;
}
...
export class OriginalGroupHeader17 {
	OrgnlMsgId: string;
	OrgnlMsgNmId: string;
	OrgnlCreDtTm: string;
	OrgnlNbOfTxs: string;
	OrgnlCtrlSum: number;
	GrpSts: string;
	StsRsnInf: Array<StatusReasonInformation12>;
	NbOfTxsPerSts: Array<NumberOfTransactionsPerStatus5>;
}
...
export class OriginalTransactionReference31 {
...
export class PaymentTransaction123 {
	StsId: string;
...
// StatusReason6Choice 
export class StatusReason6Choice {
	Cd: string;
	Prtry: string;
}

// StatusReasonInformation12 
export class StatusReasonInformation12 {
