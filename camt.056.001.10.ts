...
export class CancellationReason33Choice {
	Cd: string;
	Prtry: string;
}
...
export type ExternalCancellationReason1Code = string;
...
export class FIToFIPaymentCancellationRequestV10 {
	Assgnmt: CaseAssignment5;
	Case: Case5;
	CtrlData: ControlData1;
	Undrlyg: Array<UnderlyingTransaction28>;
...
export type GroupCancellationIndicator = boolean;
...
export class OriginalGroupHeader15 {
	GrpCxlId: string;
	Case: Case5;
	OrgnlMsgId: string;
	OrgnlMsgNmId: string;
	...
	CtrlSum: number;
	GrpCxl: boolean;
	CxlRsnInf: Array<PaymentCancellationReason5>;
}
...
export class PaymentCancellationReason5 {
...
export class PaymentTransaction137 {
	CxlId: string;
	Case: Case5;
...
export class UnderlyingTransaction28 {
	OrgnlGrpInfAndCxl: OriginalGroupHeader15;
	TxInf: Array<PaymentTransaction137>;
}
